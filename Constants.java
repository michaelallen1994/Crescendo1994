...
public final class Constants {
  ...
  public static class DriveConstants { 
    ...
    public static class ShooterConstants {
      ...
      public static final double kClear = -1;
      public static final double kStop = 0;
    }
    public static class LoaderConstants {
      public static final int kLoaderMotorPort = 7;
    ...
    public static class DeployConstants {
      public static final int kDeployMotorPort = 8;
      public static final double kDeploy = .5;
      public static final double kRetract = 1;
      public static final double kMid = .3;
      public static final double kStop = 0;
    }
}
